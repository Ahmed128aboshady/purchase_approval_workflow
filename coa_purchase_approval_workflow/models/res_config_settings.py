...
class ResConfigSettings(models.TransientModel):
    ...
    purchase_approval_enabled = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.enabled',
    ...
    purchase_approval_multi_level = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.enable_multi_level',
    ...
    purchase_approval_email_notifications = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.enable_email_notifications',
    ...
    purchase_approval_mail_activities = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.enable_mail_activities',
    ...
    purchase_approval_manager_override = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.allow_manager_override',
    ...
    purchase_approval_auto_confirm = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.auto_confirm_after_approval',
    ...
    purchase_approval_sla_enabled = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.enable_sla',
    ...
    purchase_approval_trusted_vendor_bypass = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.enable_trusted_vendor_bypass',
    ...
    purchase_approval_budget_check = fields.Boolean(
        ...
        config_parameter='coa_purchase_approval_workflow.enable_budget_check',
